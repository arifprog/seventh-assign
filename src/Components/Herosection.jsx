    ...
    <>
      <section className="bg-[url('/image/Hero.png')] bg-no-repeat bg-center bg-cover  max-w-auto h-[573px] relative">
        ...
        <div className="w-full md:w-[450px] h-[78px] absolute mt-[290px] mx-4 md:mx-20">
          <p className='font-primary text-[16px] md:text-[20px] text-[#ffffffe4]'>Train an aiDR on your ICP and messaging matrix. Activate it on a patch. It will send personalized sequences to every target contact.</p>
        </div>
